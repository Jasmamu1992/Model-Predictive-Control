...
public:
    ...
    void operator()(ADvector& fg, const ADvector& vars) {
        ...
        for (int t = 1; t < N; t++) {
            ...
            AD<double> fx = coeffs[0] + coeffs[1] * x0 + coeffs[2] * x0 * x0
                          + coeffs[3] * x0 * x0 * x0;
            ...
            fg[1 + cte_start + t] = cte1 - (fx - y0 + v0 * sin(epsi0) * dt);
            fg[1 + epsi_start + t] = epsi1 - (psi0 - psi_des + v0 * delta0 * dt / Lf);
        }
    }
};
