    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          delta = -delta;// The direction of steer in simulator is opposite to model
          double a = j[1]["throttle"];

          // Transforming waypoints to car frame of reference
          ...
          // Fitting a polynomial to the transfored waypoints
          ...
          */
          ...
          // Initial state after waypoint tranformation to vehicle reference
          px = 0;
          py = 0;
          psi = 0;
          ...
          for (unsigned int i = 0; i < mpc.mpc_x.size(); i++){
          ...
          for (unsigned int i = 0; i < ptsx.size(); i++){
              next_x_vals.push_back(pts_x(i));
              next_y_vals.push_back(pts_y(i));
          }
